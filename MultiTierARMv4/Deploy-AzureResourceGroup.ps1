...
Write-Verbose -Message "Template is: $($PSBoundParameters.TemplateFile)" -Verbose
...
if ($UploadArtifacts) {
    ...
    if ($ArtifactsLocationSasToken -eq $null) {
        ...
        $ArtifactsLocationSasToken = New-AzureStorageContainerSASToken -Container $StorageContainerName -Context $StorageAccountContext -Permission r -ExpiryTime (Get-Date).AddHours(12)
